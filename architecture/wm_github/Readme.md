...
# AssetGuard module: Github architecture
## Index
1. [Purpose](#purpose)
...
AssetGuard has the ability to obtain and process Github audit log through:
- Github module

## Sequence Diagram
Sequence diagram shows the basic flow of AssetGuard Github integration based on the configuration provided. Steps are:
...
5. Insert events into assetguard DB.
