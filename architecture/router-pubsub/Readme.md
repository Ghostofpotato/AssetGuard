...
# AssetGuard module: Router PubSub architecture
## Index
- [AssetGuard module: Router PubSub architecture](#assetguard-module-router-pubsub-architecture)
  - [Index](#index)
  - [Purpose](#purpose)
...
- 001-sequence-initialize: It explains the assetguard module router initialization, construction, use, destruction and stop from the assetguard modules daemon perspective.
