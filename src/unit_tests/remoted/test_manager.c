...
#include "../wrappers/assetguard/os_crypto/sha256_op_wrappers.h"
#include "../wrappers/assetguard/shared/hash_op_wrappers.h"
#include "../wrappers/assetguard/shared/agent_op_wrappers.h"
#include "../wrappers/assetguard/remoted/shared_download_wrappers.h"
#include "../wrappers/posix/dirent_wrappers.h"
#include "../wrappers/posix/unistd_wrappers.h"
#include "../wrappers/assetguard/remoted/request_wrappers.h"
#include "../wrappers/assetguard/remoted/remoted_op_wrappers.h"
#include "../wrappers/assetguard/shared/assetguarddb_queries_op_wrappers.h"
#include "../wrappers/assetguard/shared/hash_op_wrappers.h"

#ifdef TEST_SERVER
#define ARGV0 "assetguard-manager-remoted"
#endif
...
void test_lookfor_agent_group_with_group()
{
    ...
    char *msg = "Linux |localhost.localdomain |4.18.0-240.22.1.el8_3.x86_64 |#1 SMP Thu Apr 8 19:01:30 UTC 2021 |x86_64 [CentOS Linux|centos: 8.3] - AssetGuard v4.2.0 / ab73af41699f13fdd81903b5f23d8d00\nc2305e0ac17e7176e924294c69cc7a24 merged.mg\n#\"_agent_ip\":10.0.2.4";
    char *r_group = NULL;
...
void test_lookfor_agent_group_msg_without_enter()
{
    ...
    char *msg = "Linux |localhost.localdomain |4.18.0-240.22.1.el8_3.x86_64 |#1 SMP Thu Apr 8 19:01:30 UTC 2021 |x86_64 [CentOS Linux|centos: 8.3] - AssetGuard v4.2.0 / ab73af41699f13fdd81903b5f23d8d00c2305e0ac17e7176e924294c69cc7a24 merged.mg";
    char *r_group = NULL;
...
void test_validate_control_msg_shutdown_success(void** state)
{
    ...
    expect_string(__wrap__minfo, formatted_msg, "assetguard: Agent stopped: [001] (agent1).");
...
void test_validate_control_msg_startup_success(void** state)
{
    ...
    expect_string(__wrap_compare_assetguard_versions, version1, __assetguard_version);
    expect_string(__wrap_compare_assetguard_versions, version2, "v4.6.0");
    expect_value(__wrap_compare_assetguard_versions, compare_patch, false);
...
void test_validate_control_msg_get_agent_version_fail(void** state)
{
    ...
    // but we need to queue it for assetguard-manager-db processing
    assert_int_equal(result, 1);
    assert_int_equal(is_startup, 1);
    assert_int_equal(is_shutdown, 0);
    assert_non_null(cleaned_msg);
...
void test_save_controlmsg_startup(void **state)
{
    ...
    expect_string(__wrap_compare_assetguard_versions, version1, "v4.5.0");
    expect_string(__wrap_compare_assetguard_versions, version2, "v4.5.0");
    expect_value(__wrap_compare_assetguard_versions, compare_patch, false);
    will_return(__wrap_compare_assetguard_versions, 0);
