...
#include "../../assetguard_db/src/wdb_state.h"
...
void test_assetguarddb_create_state_json(void** state)
{
...
int main(void)
{
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test_setup_teardown(test_assetguarddb_create_state_json, test_setup, test_teardown),
    };
