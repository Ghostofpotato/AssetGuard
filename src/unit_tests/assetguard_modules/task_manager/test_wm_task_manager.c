...
#include "../../wrappers/assetguard/shared/cluster_op_wrappers.h"
#include "../../wrappers/assetguard/shared/debug_op_wrappers.h"
#include "../../wrappers/assetguard/shared/pthreads_op_wrappers.h"
#include "../../wrappers/assetguard/os_net/os_net_wrappers.h"
#include "../../wrappers/assetguard/assetguard_modules/wm_task_manager_wrappers.h"
...
void test_wm_task_manager_destroy(void **state)
{
    ...
    expect_string(__wrap__mtinfo, tag, "assetguard-manager-modulesd:task-manager");
...
void test_wm_task_manager_init_bind_err(void **state)
{
    ...
    expect_string(__wrap__mterror, tag, "assetguard-manager-modulesd:task-manager");
...
void test_wm_task_manager_dispatch_ok(void **state)
{
    ...
    expect_string(__wrap__mtdebug1, tag, "assetguard-manager-modulesd:task-manager");
