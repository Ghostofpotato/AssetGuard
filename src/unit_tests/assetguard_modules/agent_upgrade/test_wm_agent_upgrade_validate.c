...
#include "../../wrappers/assetguard/shared/url_wrappers.h"
#include "../../wrappers/assetguard/os_crypto/sha1_op_wrappers.h"
#include "../../wrappers/assetguard/assetguard_db/wdb_wrappers.h"
#include "../../wrappers/assetguard/assetguard_modules/wm_agent_upgrade_wrappers.h"
...
void test_wm_agent_upgrade_validate_wpk_version_windows_https_ok(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.assetguard.com/4.x/wpk/windows/versions");
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.assetguard.com/4.x/wpk/windows/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v4.0.0_windows.wpk");
...
void test_wm_agent_upgrade_validate_wpk_version_windows_http_ok(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://packages.assetguard.com/wpk/windows/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "http://packages.assetguard.com/wpk/windows/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v3.13.1_windows.wpk");
...
void test_wm_agent_upgrade_validate_wpk_version_windows_invalid_version(void **state)
{
    wm_agent_info *agent = state[0];
    wm_upgrade_task *task = state[1];
    char *repo = "packages.assetguard.com/4.x/wpk";
    char *versions = NULL;
    ...
    expect_string(__wrap_wurl_http_get, url, "http://packages.assetguard.com/4.x/wpk/windows/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
...
void test_wm_agent_upgrade_validate_wpk_version_windows_invalid_repo(void **state)
{
    wm_agent_info *agent = state[0];
    wm_upgrade_task *task = state[1];
    char *repo = "error.assetguard.com/wpk/";
    char *versions = NULL;
    ...
    expect_string(__wrap_wurl_http_get, url, "http://error.assetguard.com/wpk/windows/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
...
void test_wm_agent_upgrade_validate_wpk_version_linux_https_ok(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.assetguard.com/4.x/wpk/linux/x64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.assetguard.com/4.x/wpk/linux/x64/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v4.0.0_linux_x64.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_http_ok(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://packages.assetguard.com/wpk/linux/x64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "http://packages.assetguard.com/wpk/linux/x64/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v3.13.1_linux_x64.wpk");
    assert_string_equal(task->wpk_sha1, "4a313b1312c23a213f2e3209fe0909dd");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_invalid_version(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://packages.assetguard.com/4.x/wpk/linux/x64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
...
void test_wm_agent_upgrade_validate_wpk_version_linux_invalid_repo(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://error.assetguard.com/wpk/linux/x64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
...
void test_wm_agent_upgrade_validate_wpk_version_ubuntu_old_version(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.assetguard.com/wpk/ubuntu/16.04/x64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.assetguard.com/wpk/ubuntu/16.04/x64/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v3.3.0_ubuntu_16.04_x64.wpk");
...
void test_wm_agent_upgrade_validate_wpk_version_rhel_old_version(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.assetguard.com/wpk/rhel/6/x86/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.assetguard.com/wpk/rhel/6/x86/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v3.3.0_rhel_6_x86.wpk");
    assert_string_equal(task->wpk_sha1, "ad87687f6876e876876bb86ad54e57aa");
}
...
void test_wm_agent_upgrade_validate_wpk_version_macos_https_ok(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.assetguard.com/4.x/wpk/macos/x64/pkg/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.assetguard.com/4.x/wpk/macos/x64/pkg/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v4.0.0_macos_x64.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_macos_http_ok(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://packages.assetguard.com/wpk/macos/x64/pkg/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "http://packages.assetguard.com/wpk/macos/x64/pkg/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v3.13.1_macos_x64.wpk");
    assert_string_equal(task->wpk_sha1, "4a313b1312c23a213f2e3209fe0909dd");
}
...
void test_wm_agent_upgrade_validate_wpk_version_macos_x86_64(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.assetguard.com/4.x/wpk/macos/pkg/intel64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.assetguard.com/4.x/wpk/macos/pkg/intel64/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v4.9.0_macos_intel64.pkg.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_macos_aarch64(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.assetguard.com/4.x/wpk/macos/pkg/arm64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.assetguard.com/4.x/wpk/macos/pkg/arm64/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v4.9.0_macos_arm64.pkg.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_rpm_x86_64(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.assetguard.com/4.x/wpk/linux/rpm/x86_64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.assetguard.com/4.x/wpk/linux/rpm/x86_64/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v4.9.0_linux_x86_64.rpm.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_rpm_aarch64(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.assetguard.com/4.x/wpk/linux/rpm/aarch64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.assetguard.com/4.x/wpk/linux/rpm/aarch64/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v4.9.0_linux_aarch64.rpm.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_rpm_deb(void **state)
{
    ...
    expect_string(__wrap__mtwarn, tag, "assetguard-manager-modulesd:agent-upgrade");
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_rpm_deb_force(void **state)
{
    ...
    expect_string(__wrap__mtdebug1, tag, "assetguard-manager-modulesd:agent-upgrade");
    expect_string(__wrap__mtdebug1, formatted_msg, "(8170): Agent '20' with platform 'centos' will be upgraded using package 'deb'");

    expect_string(__wrap_wurl_http_get, url, "https://packages.assetguard.com/4.x/wpk/linux/deb/amd64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.assetguard.com/4.x/wpk/linux/deb/amd64/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v4.9.0_linux_amd64.deb.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_deb_aarch64(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.assetguard.com/4.x/wpk/linux/deb/arm64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.assetguard.com/4.x/wpk/linux/deb/arm64/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v4.9.0_linux_arm64.deb.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_unsupported_x86_64(void **state)
{
    ...
    assert_int_equal(ret, WM_UPGRADE_SYSTEM_NOT_SUPPORTED);
    assert_string_equal(task->wpk_repository, "packages.assetguard.com/4.x/wpk/");
    assert_null(task->wpk_file);
    assert_null(task->wpk_sha1);
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_unsupported_rpm(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.assetguard.com/4.x/wpk/linux/rpm/i386/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.assetguard.com/4.x/wpk/linux/rpm/i386/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v4.9.0_linux_i386.rpm.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_unsupported_deb(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "https://packages.assetguard.com/4.x/wpk/linux/deb/i386/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "https://packages.assetguard.com/4.x/wpk/linux/deb/i386/");
    assert_string_equal(task->wpk_file, "assetguard_agent_v4.9.0_linux_i386.deb.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
{
    wm_upgrade_task *task = state[1];
    char *assetguard_version = "v4.14.0";
    char *platform = "ubuntu";

    task->force_upgrade = false;

    int ret = wm_agent_upgrade_validate_version(assetguard_version, platform, WM_UPGRADE_UPGRADE, task);
...
void test_wm_agent_upgrade_validate_version_upgrade_custom_ok(void **state)
{
    ...
    int ret = wm_agent_upgrade_validate_version(assetguard_version, platform, WM_UPGRADE_UPGRADE_CUSTOM, task);
...
{
    wm_upgrade_task *task = state[1];
    char *assetguard_version = "v2.1.1";
    char *platform = "ubuntu";
...
{
    wm_upgrade_task *task = state[1];
    char *assetguard_version = "v4.15.0";
    char *platform = "ubuntu";
...
{
    wm_upgrade_task *task = state[1];
    char *assetguard_version = "v4.13.0";
    char *platform = "ubuntu";
...
{
    wm_upgrade_task *task = state[1];
    char *assetguard_version = "v5.0.0";
    char *platform = "ubuntu";
...
void test_wm_agent_upgrade_validate_wpk_exist(void **state)
{
    ...
    os_strdup("https://packages.assetguard.com/4.x/wpk/windows/", task->wpk_repository);
    os_strdup("assetguard_agent_v4.0.0_windows.wpk", task->wpk_file);
    os_strdup(sha1, task->wpk_sha1);

    expect_string(__wrap_wfopen, path, "var/upgrade/assetguard_agent_v4.0.0_windows.wpk");
    expect_string(__wrap_wfopen, mode, "rb");
    will_return(__wrap_wfopen, 1);

    expect_string(__wrap_OS_SHA1_File, fname, "var/upgrade/assetguard_agent_v4.0.0_windows.wpk");
...
void test_wm_agent_upgrade_validate_wpk_exist_diff_sha1(void **state)
{
    ...
    expect_string(__wrap__mtdebug1, tag, "assetguard-manager-modulesd:agent-upgrade");
    expect_string(__wrap__mtdebug1, formatted_msg, "(8161): Downloading WPK file from: 'https://packages.assetguard.com/4.x/wpk/windows/assetguard_agent_v4.0.0_windows.wpk'");

    expect_string(__wrap_wurl_request, url, "https://packages.assetguard.com/4.x/wpk/windows/assetguard_agent_v4.0.0_windows.wpk");
    expect_string(__wrap_wurl_request, dest, "var/upgrade/assetguard_agent_v4.0.0_windows.wpk");
...
void test_wm_agent_upgrade_validate_task_status_message_error_code(void **state)
{
    ...
    expect_string(__wrap__mterror, tag, "assetguard-manager-modulesd:agent-upgrade");
