...
#include <cmocka.h>
#include <stdio.h>
#include "../../wrappers/assetguard/data_provider/sysInfo_wrappers.h"
...
#ifdef TEST_SERVER
#define WM_CONTROL_TEST_LOGTAG "assetguard-manager-modulesd:control"
#else
#define WM_CONTROL_TEST_LOGTAG "assetguard-modulesd:control"
#endif
