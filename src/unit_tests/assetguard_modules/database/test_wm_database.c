...
void test_wm_sync_group_file_error_agent_id(void **state) {
    ...
    expect_string(__wrap__mtdebug1, tag, "assetguard-manager-modulesd:database");
...
void test_sync_keys_with_wdb_insert(void **state) {
    ...
    expect_string(__wrap__mtdebug2, tag, "assetguard-manager-modulesd:database");
...
void test_sync_keys_with_wdb_null(void **state) {
    ...
    expect_string(__wrap__mterror, tag, "assetguard-manager-modulesd:database");
