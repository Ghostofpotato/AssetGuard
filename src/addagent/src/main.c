...
{
    printf("\n");
    printf(BANNER, __assetguard_name, __assetguard_version, (int)(21 - strlen(__assetguard_name) - strlen(__assetguard_version)), "                     ");
...
int main(int argc, char **argv)
{
    ...
    /* Check permissions */
    fp = wfopen(ASSETGUARDCONF, "r");
    if (fp) {
        fclose(fp);
    } else {
        merror_exit(CONF_ERROR, ASSETGUARDCONF);
    }
#endif
