...
int main(int argc, char **argv)
{
    ...
    wmodule *cur_module;
    wm_debug_level = getDefine_Int("assetguard_modules", "debug", 0, 2);
    ...
    int nofile = getDefine_Int("assetguard_modules", "rlimit_nofile", 8192, 1048576);
...
void wm_handler(int signum)
{
    ...
    case SIGTERM:
        ...
        minfo("Shutting down AssetGuard modules.");
