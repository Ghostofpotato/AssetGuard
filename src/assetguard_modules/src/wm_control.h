...
/**
 * @brief Execute restart or reload action on the AssetGuard manager
 *
 * Detects if systemd is available and uses systemctl, otherwise falls back to assetguard-control.
