...
extern int wm_max_eps;          // Maximum events per second sent by AssetGuard Module
...
/*
 * @brief Get ID group of AssetGuard user.
 *
 * @return ID group.
 */
...
/*
 * @brief Set ID group of assetguard modules
 *
