 ...
 *
 * @param [in] input The chunk obtained from AssetGuardDB to be parsed.
...
/**
 * @brief Function to get the information of a particular agent stored in AssetGuard DB.
 *
 * @param wdb The Global struct database.
 * @param id Agent id.
...
/**
 * @brief Method to read the internal assetguard-db configuration.
 *
