...
public:
    ...
    {
        std::cout << "\nUsage: assetguard-manager-keystore <option(s)>\n"
                  << "Options:\n"
                  ...
                  << "\nExample:"
                  << "\n\t./assetguard-manager-keystore -f indexer -k username -v admin\n"
                  << "\n\t./assetguard-manager-keystore -f indexer -k password -vp /path/to/file.txt\n"
                  << "\n\t./assetguard-manager-keystore -f indexer -k password < /path/to/file.txt\n"
                  << "\n\techo 'pass' | ./assetguard-manager-keystore -f indexer -k password\n"
                  << "\n\tcat /path/to/file.txt | ./assetguard-manager-keystore -f indexer -k password\n"
                  << std::endl;
    }
