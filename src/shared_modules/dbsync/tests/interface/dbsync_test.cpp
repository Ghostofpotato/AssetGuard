...
TEST_F(DBSyncTest, GetDeletedRowsOnlyPKs)
{
    ...
    auto syncSqlStmt1 = SyncRowQuery::builder().table("processes")
                        .data(nlohmann::json::parse(R"({"pid":4,"name":"System","euser":"assetguard"})"))
                        .query();
    auto syncSqlStmt2 = SyncRowQuery::builder().table("processes")
                        .data(nlohmann::json::parse(R"({"pid":7,"name":"Guake","euser":"assetguard"})"))
                        .query();
    ...
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"System","pid":4,"euser":"assetguard"})"))).Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"Guake","pid":7,"euser":"assetguard"})"))).Times(1);
    EXPECT_CALL(wrapper, callbackMock(DELETED, nlohmann::json::parse(R"({"euser":"assetguard","name":"System","pid":4})"))).Times(1);
...
TEST_F(DBSyncTest, GetDeletedRowsAllAttributes)
{
    ...
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"System","pid":4,"euser":"assetguard"})"))).Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"Guake","pid":7,"euser":"assetguard"})"))).Times(1);
    EXPECT_CALL(wrapper, callbackMock(DELETED, nlohmann::json::parse(R"({"name":"System","pid":4,"euser":"assetguard"})"))).Times(1);
