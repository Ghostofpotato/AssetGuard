...
3. [Compile AssetGuard](#compile-assetguard)
...
## Compile AssetGuard
In order to run unit tests on a specific assetguard target, the project needs to be built either in release or debug mode.
```
