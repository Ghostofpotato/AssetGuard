...
assetguard_binaries = {
    "manager": set(["assetguard-manager-analysisd", "assetguard-manager-authd",
                "assetguard-manager-monitord", "assetguard-manager-remoted", "assetguard-manager-modulesd",
                "assetguard-manager-clusterd", "assetguard-manager-db", ]),
    "agent": set(["assetguard-agentd", "assetguard-execd", "assetguard-logcollector",
              "assetguard-syscheckd", "assetguard-modulesd", ]),
    "winagent": set(["assetguard-agent.exe", ])
}


def check_binary(binary_list):
    for binary in binary_list:
        for _, binaries in assetguard_binaries.items():
