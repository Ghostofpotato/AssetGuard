...
The library provides a client interface to communicate locally with assetguard-engine. 
...
The library provides a client interface to communicate with assetguard-engine.
