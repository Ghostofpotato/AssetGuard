...
ENGINE_LOGPAR_TYPE_PATH="${SCHEMA_PATH}/assetguard-logpar-overrides"
...
cp "${ENGINE_SRC}/ruleset/schemas/assetguard-logpar-overrides.json" "${ENGINE_LOGPAR_TYPE_PATH}/0"
