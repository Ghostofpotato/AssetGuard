...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        TermT(R"(hp($assetguard.protocol.queue) )", makeSuccess<HelperToken>({"hp", Reference("assetguard.protocol.queue")}, 25)),
        TermT(R"(hp($assetguard.protocol.queue) ())", makeSuccess<HelperToken>({"hp", Reference("assetguard.protocol.queue")}, 25)),
        TermT(R"(hp($assetguard.protocol.queue)==())", makeSuccess<HelperToken>({"hp", Reference("assetguard.protocol.queue")}, 25)),
        TermT(R"(hp($assetguard.protocol.queue) AND)", makeSuccess<HelperToken>({"hp", Reference("assetguard.protocol.queue")}, 25)),
        TermT(R"(hp($assetguard.protocol.queue)==)", makeSuccess<HelperToken>({"hp", Reference("assetguard.protocol.queue")}, 25)),
        TermT(R"(hp($assetguard.protocol.queue)!!)", makeSuccess<HelperToken>({"hp", Reference("assetguard.protocol.queue")}, 25)),
        TermT(R"(hp($assetguard.protocol.queue)>)", makeSuccess<HelperToken>({"hp", Reference("assetguard.protocol.queue")}, 25)),
        TermT(R"(hp($assetguard.protocol.queue, ,\ \,) )",
              makeSuccess<HelperToken>({"hp", Reference("assetguard.protocol.queue"), {val(), val(R"(" ,")")}}, 32)),
        TermT(R"(hp($assetguard.protocol.queue, ,\ \,) ())",
              makeSuccess<HelperToken>({"hp", Reference("assetguard.protocol.queue"), {val(), val(R"(" ,")")}}, 32)),
        TermT(R"(hp($assetguard.protocol.queue, ,\ \,)==())",
              makeSuccess<HelperToken>({"hp", Reference("assetguard.protocol.queue"), {val(), val(R"(" ,")")}}, 32)),
        TermT(R"(hp($assetguard.protocol.queue, ,\ \,) AND)",
              makeSuccess<HelperToken>({"hp", Reference("assetguard.protocol.queue"), {val(), val(R"(" ,")")}}, 32)),
        TermT(R"(hp($assetguard.protocol.queue, ,\ \,)==)",
              makeSuccess<HelperToken>({"hp", Reference("assetguard.protocol.queue"), {val(), val(R"(" ,")")}}, 32)),
        TermT(R"(hp($assetguard.protocol.queue, ,\ \,)!!)",
