...
/**
 * @brief Discard events helper - sets assetguard.space.event_discarded and optionally clears fields
 *
 ...
 *
 * Usage: assetguard.space.event_discarded: +discard_events
 *
 * @param targetField target field (must be "assetguard.space.event_discarded")
 ...
 * @throw std::runtime_error if target field is not assetguard.space.event_discarded or if parameters are provided
 */
