...
constexpr auto OSSEC_DEFINES = "/var/assetguard-manager/etc/internal_options.conf";
constexpr auto OSSEC_LDEFINES = "/var/assetguard-manager/etc/local_internal_options.conf";
