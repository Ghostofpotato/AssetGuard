...
## Compile AssetGuard
In order compile the solution on a specific assetguard target, the project needs to be built either in os_kernel_release or debug mode.
```
