...
int w_is_worker(void) {
    OS_XML xml;
    const char * xmlf[] = {ASSETGUARDCONFIG, "cluster", NULL};
    const char * xmlf2[] = {ASSETGUARDCONFIG, "cluster", "node_type", NULL};
    const char *cfgfile = ASSETGUARDCONF;
...
char *get_master_node(void) {
    OS_XML xml;
    const char * xmlf[] = {ASSETGUARDCONFIG, "cluster", "nodes", "node", NULL};
    const char *cfgfile = ASSETGUARDCONF;
...
char *get_node_name(void) {
    OS_XML xml;
    const char * xmlf[] = {ASSETGUARDCONFIG, "cluster", "node_name", NULL};
    const char *cfgfile = ASSETGUARDCONF;
    char *node_name = NULL;
...
char *get_cluster_name(void) {
    OS_XML xml;
    const char * xmlf[] = {ASSETGUARDCONFIG, "cluster", "name", NULL};
    const char *cfgfile = ASSETGUARDCONF;
