 ...
 *
 * AssetGuard agents need to register to a manager before being able to start sending messages
 ...
 * For details on enrollment process @see https://documentation.assetguard.com/3.12/user-manual/registering/
 */
...
typedef struct _enrollment_ctx {
    ...
    char *agent_version;                /**< will hold the __assetguard_version value*/
