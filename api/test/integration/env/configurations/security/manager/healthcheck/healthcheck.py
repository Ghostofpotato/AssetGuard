...
def get_master_health():
    os.system("/var/assetguard-manager/bin/assetguard-manager-control status > /tmp_volume/daemons.txt")
...
if __name__ == "__main__":
    ...
    exit(get_master_health()) if socket.gethostname() == 'assetguard-master' else exit(0)
