...
from assetguard.core.results import AbstractAssetGuardResult


class AssetGuardAPIJSONEncoder(JSONEncoder):
    """"
    Define the custom AssetGuard API JSON encoder class.
    """
    include_nulls = False
    ...
    def default(self, o: object) -> dict:
        ...
        if isinstance(o, Model):
            ...
            for attr, _ in six.iteritems(o.swagger_types):
                ...
                result[attr] = value
            return result
        elif isinstance(o, AbstractAssetGuardResult):
            return o.render()
...
def dumps(obj: object) -> str:
    ...
    str
    """
    return json.dumps(obj, cls=AssetGuardAPIJSONEncoder)
...
def prettify(obj: object) -> str:
    ...
    str
    """
    return json.dumps(obj, cls=AssetGuardAPIJSONEncoder, indent=3)
