...
class AssetGuardAccessLoggerMiddleware(BaseHTTPMiddleware):
    """Middleware to log custom Access messages."""

    async def dispatch(self, request: Request, call_next: RequestResponseEndpoint) -> Response:
        """Log AssetGuard access information.
        ...
        if body:
            try:
                ...
                # Related to https://github.com/assetguard/assetguard/issues/24060.
