...
def read_random_pass():
    """
    Search for the random password creation in AssetGuard logs
    """
    passw = None
    try:
        with open(ASSETGUARD_LOG_PATH, 'r') as log_file:
...
def test_authd_use_password(test_configuration, test_metadata, set_assetguard_configuration,
