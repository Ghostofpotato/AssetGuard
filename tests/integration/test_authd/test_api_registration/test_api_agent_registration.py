...
references:
    - https://documentation.assetguard.com/current/user-manual/registering/restful-api-registration.html
...
from assetguard_testing.utils.client_keys import get_client_keys
from assetguard_testing.modules.api.utils import get_base_url, login
...
def test_agentd_server_configuration(test_metadata, truncate_monitored_files_module,
    ...
    '''
    description:
        Checks `assetguard-api` responds correctly to agent registration requests. Also, ensure client.keys is update
