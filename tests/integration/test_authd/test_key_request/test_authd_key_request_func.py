...
brief: These tests will check if the 'assetguard-manager-authd' daemon correctly handles the key requests
...
def test_key_request_func(test_configuration, test_metadata, set_assetguard_configuration, connect_to_sockets,
