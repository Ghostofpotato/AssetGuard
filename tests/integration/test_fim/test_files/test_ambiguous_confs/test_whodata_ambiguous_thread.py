...
from assetguard_testing.modules.fim.patterns import REALTIME_WHODATA_ENGINE_STARTED
...
def test_whodata_ambiguous_thread(test_configuration, test_metadata, set_assetguard_configuration, configure_local_internal_options,
    ...
    input_description: Two test cases are contained in external YAML file (cases_whodata_ambiguous_thread.yaml)
                       which includes configuration settings for the 'assetguard-syscheckd' daemon and testing
