...
def test_upload_configuration(test_configuration, test_metadata, backup_assetguard_configuration, add_configuration,
    ...
    parameters:
        ...
        - backup_assetguard_configuration:
            type: fixture
            brief: Save the initial assetguard configuration and restore it after the test.
        - add_configuration:
            type: fixture
