...
brief: These tests will check if the set_secure_headers middleware of the API handled by the 'assetguard-manager-apid' daemon is
       working properly. The AssetGuard API is an open source 'RESTful' API that allows for interaction with the AssetGuard
...
from assetguard_testing.constants.api import AGENTS_ROUTE, CONFIGURATION_TYPES
