...
from assetguard_testing.modules.analysisd.testrule import patterns
...
def test_invalid_signature_id(test_configuration, test_metadata, set_assetguard_configuration, truncate_monitored_files,
    ...
    test_phases:
        - Setup:
            ...
            - Clean logs files and restart assetguard to apply the configuration.
        - Test:
    ...
    parameters:
        ...
        - set_assetguard_configuration:
            type: fixture
            brief: Set assetguard configuration.
    ...
    assertions:
        - Check that assetguard starts
        - Check ".*assetguard-testrule.*Empty 'if_sid' value. Rule '(\\d*)' will be ignored.*"
    ...
    '''
    # Start monitor
    monitor_invalid = file_monitor.FileMonitor(ASSETGUARD_LOG_PATH)
