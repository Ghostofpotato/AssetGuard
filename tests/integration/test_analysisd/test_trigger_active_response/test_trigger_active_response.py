...
def test_rules_triggers_ar(test_configuration, test_metadata, truncate_monitored_files, set_assetguard_configuration,
    ...
    test_phases:
        - setup:
            - Copy custom rule and active response files to AssetGuard paths.
            - Create a new file which will be monitored with logcollector.
            - Set assetguard configuration (add active_response command and localfile blocks).
        ...
        - teardown:
            ...
            - Restart initial assetguard configuration.

    assetguard_min_version: 4.3.5
