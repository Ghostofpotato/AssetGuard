...
def test_enabled(test_configuration, test_metadata, load_assetguard_basic_configuration, set_assetguard_configuration,
...
def test_disabled(test_configuration, test_metadata, load_assetguard_basic_configuration, set_assetguard_configuration,
                 truncate_monitored_files, daemons_handler):
    """
    ...
    """
    # Start monitor
    monitor_disabled = file_monitor.FileMonitor(ASSETGUARD_LOG_PATH)
