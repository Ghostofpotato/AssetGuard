...
| **Version**                           | ASSETGUARD_VERSION                                             |
| **Release candidate**                 | RC_VERSION                                                |
| **assetguard/assetguard tag**                   | https://github.com/assetguard/assetguard/tree/vASSETGUARD_VERSION-TAG    |
| **assetguard/assetguard-qa tag**                | https://github.com/assetguard/assetguard-qa/tree/vASSETGUARD_VERSION-TAG |
...
The objective of this issue is to check that the integration tests pass successfully against the version `ASSETGUARD_VERSION` of AssetGuard.
