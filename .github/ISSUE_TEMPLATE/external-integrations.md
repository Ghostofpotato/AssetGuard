...
- AssetGuard mailing list: https://groups.google.com/forum/#!forum/assetguard
- Join AssetGuard on Slack: https://assetguard.com/community/join-us-on-slack
...
- Indicate the AssetGuard version.
- Tell if it has failed on a manager, an agent, or both.
- Attach logs that illustrate the bug inside the <detail> tag below -you may want to set debug options `assetguard_modules.debug=2` and restart AssetGuard (see https://documentation.assetguard.com/current/user-manual/reference/internal-options.html) to get verbose logs. This may help investigate the issue-.
