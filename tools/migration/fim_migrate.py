...
# Database support for AssetGuard HIDS.
# Copyright (C) 2015, AssetGuard Inc. <info@assetguard.com>
# September 28, 2018.
...
def _print_help():
    print('''
    FIM database upgrade tool for AssetGuard
...
if __name__ == '__main__':
    ...
    if _verbose:
        logging.debug("Connected to AssetGuardDB socket ({0})".format(_wdb_socket))
