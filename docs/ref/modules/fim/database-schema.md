...
These schemas define the standardized format for FIM data that is sent to the AssetGuard indexer.
...
Database files are stored in fixed locations relative to AssetGuard installation:
