...
from assetguard.core.utils import AssetGuardDBQuery, AssetGuardDBBackend, get_utc_strptime
from assetguard.core.utils import process_array

# Default request_slice value
DEFAULT_REQUEST_SLICE = 500

# Optimal request_slice values for each AssetGuardDBQuery
# TACTICS_REQUEST_SLICE = 500  # Default AssetGuardDBQueryMitre request_slice value
...
class AssetGuardDBQueryMitre(AssetGuardDBQuery):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 distinct: bool = False):
        """Create an instance of the AssetGuardDBQueryMitre class.
        ...
        request_slice : int
            Max limit used in the AssetGuardDBBacked backend object.
        distinct : bool
        ...
        AssetGuardDBQuery.__init__(self, offset=offset, limit=limit, table=table, sort=sort, search=search, select=select,
                              ...
                              backend=AssetGuardDBBackend(query_format='mitre', request_slice=request_slice),
                              distinct=distinct)
...
class AssetGuardDBQueryMitreMetadata(AssetGuardDBQueryMitre):
    """Class that handles the MITRE metadata."""

    TABLE_NAME = 'metadata'

    def __init__(self):
        """Create an instance of the AssetGuardDBQueryMitreMetadata class."""

        min_select_fields = {'key', 'value'}
        fields = {'key': 'key', 'value': 'value'}

        AssetGuardDBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=min_select_fields, fields=fields,
...
class AssetGuardDBQueryMitreRelational(AssetGuardDBQueryMitre, ABC):
    """Abstract class used to overload the _format_data_into_dictionary method of AssetGuardDBQueryMitre.
...
class AssetGuardDBQueryMitreRelationalPhase(AssetGuardDBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
        ...
        """Create an instance of the AssetGuardDBQueryMitreRelationalPhase class.
...
class AssetGuardDBQueryMitreRelationalMitigate(AssetGuardDBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, dict_key: str = None, request_slice: int = DEFAULT_REQUEST_SLICE):
        """Create an instance of the AssetGuardDBQueryMitreRelationalMitigate class.
...
class AssetGuardDBQueryMitreRelationalUse(AssetGuardDBQueryMitreRelational):
...
class AssetGuardDBQueryMitreMitigations(AssetGuardDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
        ...
        """Create an instance of the AssetGuardDBQueryMitreMitigations class.
        ...
        AssetGuardDBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=self.min_select_fields,
    ...
    def _execute_data_query(self):
        ...
        with AssetGuardDBQueryMitreRelationalMitigate() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with AssetGuardDBQueryMitreReferences(limit=None, filters={'type': 'mitigation'},
...
class AssetGuardDBQueryMitreReferences(AssetGuardDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None):
        """Create an instance of the AssetGuardDBQueryMitreReferences class.
...
class AssetGuardDBQueryMitreTactics(AssetGuardDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the AssetGuardDBQueryMitreTactics class.
    ...
    def _execute_data_query(self):
        ...
        with AssetGuardDBQueryMitreRelationalPhase() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with AssetGuardDBQueryMitreReferences(limit=None, filters={'type': 'tactic'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class AssetGuardDBQueryMitreTechniques(AssetGuardDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the AssetGuardDBQueryMitreTechniques class.
    ...
    def _execute_data_query(self):
        ...
        with AssetGuardDBQueryMitreRelationalPhase(dict_key='tech_id') as mitre_relational_query:
            tactics = mitre_relational_query.run()

        with AssetGuardDBQueryMitreRelationalMitigate(dict_key='target_id') as mitre_relational_query:
            mitigations = mitre_relational_query.run()

        with AssetGuardDBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'software'},
                                            dict_key='target_id',
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()

        with AssetGuardDBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'group'},
        ...
        with AssetGuardDBQueryMitreReferences(limit=None, filters={'type': 'technique'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class AssetGuardDBQueryMitreGroups(AssetGuardDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the AssetGuardDBQueryMitreGroups class.
        ...
        AssetGuardDBQueryMitre.__init__(self, table=f"`{self.TABLE_NAME}`", min_select_fields=self.min_select_fields,
                                   fields=self.fields, filters=filters, offset=offset, limit=limit, query=query,
                                   count=count, sort=sort, default_sort_field=default_sort_field,
                                   default_sort_order=default_sort_order, search=search,
                                   select=list(set(self.fields.values()).intersection(set(select))),
    ...
    def _execute_data_query(self):
        ...
        with AssetGuardDBQueryMitreRelationalUse(filters={'target_type': 'software', 'source_type': 'group'},
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()
        ...
        with AssetGuardDBQueryMitreReferences(limit=None, filters={'type': 'group'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class AssetGuardDBQueryMitreSoftware(AssetGuardDBQueryMitre):
    ...
    def _execute_data_query(self):
        ...
        with AssetGuardDBQueryMitreReferences(limit=None, filters={'type': 'software'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
def get_mitre_items(mitre_class: callable) -> tuple:
    ...
    mitre_class : callable
        AssetGuardDBQueryMitre class used to obtain certain MITRE resources.
