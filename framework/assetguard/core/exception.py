...
from assetguard.core.cluster import __version__
from assetguard.core.common import AGENT_NAME_LEN_LIMIT, MAX_GROUPS_PER_MULTIGROUP, MAX_SOCKET_BUFFER_SIZE

GENERIC_ERROR_MSG = "AssetGuard Internal Error. See log for more detail"
DOCU_VERSION = 'current' if __version__ == '' else '.'.join(__version__.split('.')[:2]).lstrip('v')

class AssetGuardException(Exception):
    """
    AssetGuard Exception object.
    """

    ERRORS = {
        # < 999: API
        900: 'One of the API child processes terminated abruptly. The API process pool is not usable anymore. '
             'Please restart the AssetGuard API',
        901: 'API executor subprocess broke. A service restart may be needed',
        902: 'API Endpoint only available on master node',

        # AssetGuard: 0999 - 1099
        999: 'Incompatible version of Python',
        1000: {'message': 'AssetGuard Internal Error',
               'remediation': 'Please, check `ASSETGUARD_HOME/logs/assetguard-manager.log`, `ASSETGUARD_HOME/logs/cluster.log` and '
                              '`ASSETGUARD_HOME/logs/api.log` to get more information about the error'},
        ...
        1005: {'message': 'Error reading file',
               'remediation': 'Please, ensure you have the right file permissions in AssetGuard directories'},
        1006: {'message': 'File/directory does not exist or there is a problem with the permissions',
               'remediation': 'Please, check if path to file/directory is correct and `assetguard-manager` '
        ...
        1013: {'message': 'Unable to connect with socket',
               'remediation': 'Please, restart AssetGuard to restore sockets'},
        ...
        1016: {'message': 'Error moving file',
               'remediation': 'Please, ensure you have the required file permissions in AssetGuard directories'},
        1017: 'Some AssetGuard daemons are not ready yet in node "{node_name}" ({not_ready_daemons})',
        1018: 'Body request is not a valid JSON',
        1019: 'Error trying to create backup file',
        1020: {'message': 'Could not find any AssetGuard log file',
               'remediation': 'Please check `ASSETGUARD_HOME/logs`'},
        ...
        1119: "Directory '/tmp' needs read, write & execution permission for 'assetguard-manager' user",
        ...
        1127: {'message': 'Protected section was modified',
               'remediation': 'To solve this, either revert the changes made to this section or disable the protection '
                              'in the API settings: '
                              f"https://documentation.assetguard.com/{DOCU_VERSION}/user-manual/api/configuration.html"},
        ...
        1129: {'message': 'Higher version agents detected',
               'remediation': f'To solve this issue, please enable agents higher versions in the API settings: '
                              f'https://documentation.assetguard.com/{DOCU_VERSION}/user-manual/api/'
        ...
        1307: {'message': 'Invalid parameters',
               'remediation': 'Please, check that the update is correct, there is a problem while reading the results, '
                              'contact us at [official repository](https://github.com/assetguard/assetguard/issues)'
               },
        ...
        1707: {'message': 'Cannot send request, agent is not active',
               'remediation': 'Please, check non-active agents connection and try again. Visit '
                              f'https://documentation.assetguard.com/{DOCU_VERSION}/user-manual/registering/index.html and '
                              f'https://documentation.assetguard.com/{DOCU_VERSION}/user-manual/agents/agent-connection.'
        ...
        1726: {'message': 'AssetGuard authd is not running',
        ...
        1728: {'message': 'Invalid node type',
               'remediation': f'Valid types are `master` and `worker`. Please, visit https://documentation.assetguard.com/'
        ...
        1730: {'message': 'Node does not exist',
               'remediation': 'Make sure the name is correct and that the node is up. You can check it using '
                              f'`cluster_control -l` (https://documentation.assetguard.com/{DOCU_VERSION}/user-manual/'
        ...
        1734: {'message': 'Error removing agent from group',
               'remediation': f'Agent does not belong to specified group, to assign the agent to a group follow: '
                              f'https://documentation.assetguard.com/{DOCU_VERSION}/user-manual/agents/grouping-agents.html'
               },
        ...
        1743: 'Error running AssetGuard syntax validator',
        ...
        1750: {'message': 'Could not send restart command, active-response is disabled in the agent',
               'remediation': "You can activate it in agents' `ASSETGUARD_HOME/etc/assetguard-manager.conf`"},
        ...
        2003: {'message': 'Error in assetguarddb request',
        ...
        2006: {'message': 'Received JSON from AssetGuard DB is not correctly formatted'},
        2007: {'message': 'Error retrieving data from AssetGuard DB'},
        2008: {'message': 'Corrupted RBAC database',
               'remediation': 'Restart the AssetGuard service to restore the RBAC database to default'},
        2009: {'message': 'Pagination error. Response from assetguard-manager-db was over the maximum socket buffer size'},
        2010: {'message': 'The requested read operation did not complete fully'},
        2011: {'message': 'Could not connect to the assetguard-manager-db unix socket'},
        2012: {'message': 'Invalid assetguard-manager-db HTTP request'},
        2013: {'message': 'Error sending HTTP request'},
        2014: {'message': 'The assetguard-manager-db client connection timeout has been exceeded'},
        2015: {'message': 'Invalid request URL scheme'},
        2016: {'message': 'Invalid unix socket path'},
        2017: {'message': 'Could not retrieve agents synchronization information from assetguard-manager-db'},
        ...
        3023: {'message': 'Worker node is not connected to master',
               'remediation': 'Check the cluster.log located at ASSETGUARD_HOME/logs/cluster.log file to see if there are '
                              'connection errors. Restart the `assetguard-manager` service.'},
        3024: "Length of command exceeds limit defined in assetguard.cluster.common.Handler.cmd_len.",
        ...
        3031: {'message': "Worker and master versions are not the same",
               'remediation': f"[Update](https://documentation.assetguard.com/{DOCU_VERSION}/upgrade-guide/index.html)"
        ...
        4000: {'message': "Permission denied",
               'remediation': "Please, make sure you have permissions to execute the current request. "
                              ...
                              f"assetguard.com/{DOCU_VERSION}/user-manual/api/rbac/configuration.html"},
        ...
        4008: {'message': 'The specified resource is required for a correct AssetGuard\'s functionality'},
        ...
        4019: {'message': 'Invalid resource specified',
               'remediation': f'Please, check the current RBAC resources, for more information please visit https:/'
                              f'/documentation.assetguard.com/{DOCU_VERSION}/user-manual/api/rbac/configuration.html'},
        ...
        5008: {'message': 'The current user cannot be deleted',
               'remediation': 'You can delete this user with the administrator user (assetguard) or '
        ...
        6001: {'message': 'Maximum number of requests per minute reached',
               'remediation': f'This limit can be changed in api.yaml file. More information here: https:/'
                              f'/documentation.assetguard.com/{DOCU_VERSION}/user-manual/api/configuration.html#'
        ...
        6003: {'message': 'Error trying to load the JWT secret',
               'remediation': 'Make sure you have the right permissions: ASSETGUARD_PATH/api/configuration/security/'
                              'jwt_secret'},
        6004: {'message': 'The current user does not have authentication enabled through authorization context',
               'remediation': f'You can enable it using the following endpoint: https://documentation.assetguard.com/'
                              f'{DOCU_VERSION}/user-manual/api/reference.html#operation/api.controllers.'
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
        ...
        """Create a AssetGuardException object.
    ...
    def __eq__(self, other):
        if not isinstance(other, AssetGuardException):
    ...
    def __or__(self, other):
        if isinstance(other, AssetGuardException):
...
class AssetGuardInternalError(AssetGuardException):
    """
    ...
    _default_title = "AssetGuard Internal Error"

    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a AssetGuardInternalError exception.
...
class AssetGuardClusterError(AssetGuardInternalError):
    """
    This type of exception is raised inside the cluster.
    """
    _default_type = "about:blank"
    _default_title = "AssetGuard Cluster Error"


class AssetGuardHAPHelperError(AssetGuardClusterError):
    """
...
class AssetGuardIndexerError(AssetGuardInternalError):
    """Indexer client exception."""

    _default_type = 'about:blank'
    _default_title = 'AssetGuard Indexer Error'


class AssetGuardError(AssetGuardException):
    """
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a AssetGuardError exception.
    ...
    def __or__(self, other):
        result: AssetGuardError = super().__or__(other)
        if isinstance(result, AssetGuardError):
...
class AssetGuardPermissionError(AssetGuardError):
    """
...
class AssetGuardResourceNotFound(AssetGuardError):
    """
...
class AssetGuardTooManyRequests(AssetGuardError):
    """
...
class AssetGuardNotAcceptable(AssetGuardError):
    """
