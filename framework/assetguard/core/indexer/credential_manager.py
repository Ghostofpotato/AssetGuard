...
from assetguard.core.common import KEY_STORE_SOCKET
from assetguard.core.assetguard_socket import AssetGuardSocket


class KeystoreClient:
    """
    Client for AssetGuard keystore communication using SizeHeaderProtocol.

    This class manages connection to the AssetGuard keystore socket and provides
    ...
    socket : AssetGuardSocket or None
    ...
    Examples
    --------
    >>> from assetguard.keystore import KeystoreClient
    ...
    def _connect(self):
        ...
        """
        self.socket = AssetGuardSocket(self.socket_path)
