...
class AssetGuardAgent:
    """Tools to handle AssetGuard agents connections."""
...
class AssetGuardDAPI:
    """Class to call AssetGuard DAPI functions."""
    ...
    def _get_logger(tag: str) -> logging.Logger:
        ...
        """
        logger = logging.getLogger('assetguard').getChild('AssetGuardDAPI')
