...
from assetguard.rbac.orm import RolesManager, TokenManager, check_database_integrity, DB_FILE
...
def update_security_conf(new_config: dict):
    ...
    if new_config:
        try:
            ...
            raise AssetGuardInternalError(1005)
    else:
        raise AssetGuardError(4021)
