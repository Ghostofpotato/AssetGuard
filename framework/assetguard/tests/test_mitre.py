...
with patch('assetguard.core.common.assetguard_uid'):
    with patch('assetguard.core.common.assetguard_gid'):
        ...
        from assetguard.tests.util import get_fake_database_data, RBAC_bypasser, InitWDBSocketMock

        assetguard.rbac.decorators.expose_resources = RBAC_bypasser
        from assetguard import mitre
        from assetguard.core import mitre as core_mitre
        from assetguard.core.common import DECIMALS_DATE_FORMAT
        from assetguard.core.utils import get_utc_strptime
