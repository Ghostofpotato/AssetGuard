...
with patch('assetguard.common.assetguard_uid'):
    with patch('assetguard.common.assetguard_gid'):
        ...
        from assetguard import task, AssetGuardError
...
@patch('assetguard.core.utils.AssetGuardDBConnection', return_value=InitWDBSocketMock(sql_schema_file='schema_tasks_test.sql'))
@patch.object(AssetGuardDBQueryTask, '_final_query', fake_final_query)
