...
def test_aws_guardduty_bucket_check_guardduty_type(mock_assetguard_aws_integration, mock_sts,
...
@patch('assetguard_integration.AssetGuardIntegration.get_sts_client')
@patch('assetguard_integration.AssetGuardAWSDatabase.__init__')
def test_aws_guardduty_bucket_check_guardduty_type_handles_exceptions(mock_assetguard_aws_integration, mock_sts):
...
@patch('assetguard_integration.AssetGuardIntegration.get_sts_client')
@patch('assetguard_integration.AssetGuardAWSDatabase.__init__')
def test_aws_guardduty_bucket_get_full_prefix(mock_assetguard_aws_integration, mock_sts, mock_service_prefix,
                                              guardduty_native):
...
@patch('assetguard_integration.AssetGuardIntegration.get_sts_client')
@patch('assetguard_integration.AssetGuardAWSDatabase.__init__')
def test_aws_guardduty_bucket_get_base_prefix(mock_assetguard_aws_integration, mock_sts, guardduty_native: bool):
...
@patch('assetguard_integration.AssetGuardIntegration.get_sts_client')
@patch('assetguard_integration.AssetGuardAWSDatabase.__init__')
def test_aws_guardduty_bucket_iter_regions_and_accounts(mock_assetguard_aws_integration, mock_sts, guardduty_native: bool):
