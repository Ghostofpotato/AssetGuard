...
class AWSSQSQueue(assetguard_integration.AssetGuardIntegration):
    ...
    def __init__(self, name: str, iam_role_arn: str, message_processor: sqs_message_processor.AWSQueueMessageProcessor,
                 ...
                 **kwargs):
        self.sqs_name = name
        assetguard_integration.AssetGuardIntegration.__init__(self, access_key=None, secret_key=None,
