...
@patch('gcloud.AssetGuardGCloudSubscriber')
...
@patch('pubsub.subscriber.AssetGuardGCloudSubscriber.check_permissions')
@patch('pubsub.subscriber.AssetGuardGCloudSubscriber.process_messages')
