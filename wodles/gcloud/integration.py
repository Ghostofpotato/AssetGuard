...
class AssetGuardGCloudIntegration:
    """Class for sending events from Google Cloud to AssetGuard."""

    header = '1:AssetGuard-GCloud:'
    key_name = 'gcp'

    def __init__(self, logger: logging.Logger):
        """Instantiate a AssetGuardGCloudIntegration object.
    ...
    def initialize_socket(self):
        ...
        Raises
        ------
        exceptions.AssetGuardIntegrationInternalError
        ...
        try:
            ...
            raise exceptions.AssetGuardIntegrationInternalError(1)
        except OSError:
            raise exceptions.AssetGuardIntegrationInternalError(2, socket_path=ANALYSISD)

    def process_data(self):
        raise NotImplementedError

    def send_msg(self, msg: str):
        """Send an event to the AssetGuard queue.
        ...
        try:
            ...
            raise exceptions.AssetGuardIntegrationInternalError(3)
