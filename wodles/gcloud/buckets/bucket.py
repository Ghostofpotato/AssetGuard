...
import exceptions
import tools
from integration import AssetGuardGCloudIntegration
...
try:
    ...
    raise exceptions.AssetGuardIntegrationException(errcode=1003, package=e.name)


class AssetGuardGCloudBucket(AssetGuardGCloudIntegration):
    ...
    def __init__(self, credentials_file: str, logger: logging.Logger, bucket_name: str, prefix: str = None,
        ...
        self.db_path = join(utils.find_assetguard_path(), "wodles/gcloud/gcloud.db")
